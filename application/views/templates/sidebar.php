...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
		...
		<div class="sidebar-brand-text mx-3">Telkomsel</div>
	</a>
	...
	<!-- Nav Item - Dashboard -->
	<?php foreach ($subMenu as $key2) { ?>
	<?php if ($title == $key2['title']) : ?>
	<li class="nav-item active">
		<?php else : ?>
	<li class="nav-item">
		<?php endif; ?>
		<a class="nav-link" href="<?php echo base_url($key2['url']); ?>">
			<i class="<?php echo $key2['icon']; ?>"></i>
			<span>
				<?php echo $key2['title']; ?>
			</span>
		</a>
